...
library(base64enc)
# authentication
user <- OAuthFactory$new(consumerKey="J2SG0K7CP8PlnqxfCC6X4qqYt",#fill ur's consumer API key
                         consumerSecret="BX0vPEOySfEY4kLaOBUHBHxLKj1njiUbhWzZMQTWj0OBifnbka",#fill ur's consumer API secret key
...
setup_twitter_oauth("J2SG0K7CP8PlnqxfCC6X4qqYt",#consumer API key
                    "BX0vPEOySfEY4kLaOBUHBHxLKj1njiUbhWzZMQTWj0OBifnbka",#consumer secret key
                    "1146289980064632839-9NqGJVUSmFIv1neU3k6m5KcDTcmyKo",#access token 
                    "GyoxlWMzXRquiKDwxbqaMRuIsD3oOn6F1B5zzVOS7izOp")#access token secret
